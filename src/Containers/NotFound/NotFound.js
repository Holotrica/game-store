...
const NotFound = (props) => {
  ...
  const animations = {
    ...
    animate: {
      opacity: 1,
      y: 0,
      transition: { y: { type: "spring", duration: 1.5, bounce: 0.5 } },
    },
    exit: {
      opacity: 0,
      y: -175,
      transition: {
        y: { type: "tween", duration: 0.675, bounce: 0.5 },
        opacity: { type: "tween", duration: 0.675 },
      },
    },
  };
  ...
  const progress = {
    ...
    animate: {
      width: 700,
      transition: { width: { type: "tween", duration: 7 } },
    },
  };
      ...
      >
        <div className={styles.notFoundContent}>
          <img
            ...
            src={require("../../Resources/image/404.png")}
          ...
          <div className={styles.notFoundText}>
            ...
            <p>
              ...
              error, <span className={styles.contact}>contact us!</span>
            </p>
          </div>
        </div>
        <motion.div
